...
<body class="bg-gray-50">
  ...
  <!-- Main Content -->
  <main class="login-bg min-h-screen py-12 px-4">
        ...
        <div class="lg:w-1/2 text-center lg:text-left">
          <div class="max-w-lg">
            <h1 class="text-5xl md:text-6xl font-serif font-bold text-white mb-6 leading-tight">
              Welcome Back to <span class="text-gray-200">ChillHaus</span>
            </h1>
            <p class="text-xl text-gray-200 mb-8">
              Continue your style journey. Access exclusive collections, track your orders, and enjoy member-only benefits.
            </p>
        ...
        <div class="lg:w-1/2 flex justify-center">
          <div class="form-container p-10 rounded-2xl w-full max-w-md">
            ...
            <div class="text-center mb-8">
              ...
              <h2 class="text-3xl font-serif font-bold text-gray-800">Member Login</h2>
              <p class="text-gray-600 mt-2">Access your ChillHaus account</p>
            </div>
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
              ...
              <!-- Login Button -->
              <button type="submit"
                      class="login-btn w-full text-white py-3 rounded-lg font-semibold text-lg">
                Log In
              </button>
              ...
              <div class="grid grid-cols-2 gap-4">
                <button type="button" 
                        class="social-btn flex items-center justify-center gap-2 py-3 rounded-lg">
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 text-center">
              <p class="text-gray-600">
                New to ChillHaus?
                <a href="{{ route('register') }}" class="text-black font-semibold hover:underline ml-1">
                  Create an account
                </a>
              </p>
            </div>
